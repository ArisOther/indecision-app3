  ...
  function (_Component) {
    ...
    function CategoricalChartWrapper(_props) {
      ...
      _this.renderGrid = function (element) {
        ...
        var yAxisWithFiniteDomain = _lodash["default"].find(yAxisMap, function (axis) {
          return _lodash["default"].every(axis.domain, Number.isFinite);
        });
            ...
            if (dataKey) {
              ...
              if (type === 'category' && isCategorial) {
                ...
                if (!allowDuplicatedCategory) {
                  domain = (0, _ChartUtils.parseDomainOfCategoryAxis)(child.props.domain, domain, child).reduce(function (finalDomain, entry) {
                    return finalDomain.indexOf(entry) >= 0 || entry === '' || _lodash["default"].isNil(entry) ? finalDomain : [].concat(_toConsumableArray(finalDomain), [entry]);
                  }, []);
                } else {
